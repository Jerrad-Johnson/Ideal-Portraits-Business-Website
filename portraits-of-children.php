<?php include 'includes/header.php'; ?>
        ...
        <meta name="description" content="This is my gallery of child portraits. I'm a photographer based in Rapid City, SD.">
        <title>Ideal Portraits | Child Photographer - Rapid City, South Dakota</title>
    ...
    <?php
        ...
        foreach($files as $file) {
            ...
            if($ext == ".JPG" || ".jpg"){
                ...
                $search = "children"; $replace = "child"; $alt = str_replace($search, $replace, $alt);
